# Generated by Django 5.2.16 on 2026-08-18 07:02
...
REWATCH_STARTED_AT = models.DateTimeField(
    blank=True,
    help_text=(
        "When the current rewatch began. Plays before it are kept as history"
        " but don't count towards the current pass."
    ),
    null=True,
)
