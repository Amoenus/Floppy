...
| 9 | `4ec98e53` | fakeredis compatibility with requests-ratelimiter | **Ported** | `requirements-dev.txt`, `src/app/providers/services.py`, commit `711b056e`; fake and real Redis expose compatible connection pools. | Done |
...
| 31 | `e6765fa6` `36a3d0d8` `0774d483` `298042ae` `c32a39cc` | uv project/lockfile, pre-commit, and Docker baseline | **Pending** | [#647](https://github.com/dannyvfilms/Floppy/issues/647) owns one app/MCP lockfile and locked consumers without dependency upgrades. | P0 / Phase 2 |
...
| 64 | `368fc461` | Built-image smoke gate and standalone Ruff workflow | **Pending / Pending** | [#646](https://github.com/dannyvfilms/Floppy/issues/646) owns image startup/MCP/restart checks; [#647](https://github.com/dannyvfilms/Floppy/issues/647) owns locked standalone Ruff execution. | P0 / Phases 1–2 |
...
| 66 | `28685442` | Align Docker builder/runtime Python versions | **Pending** | [#647](https://github.com/dannyvfilms/Floppy/issues/647) requires identical pinned Python/Alpine bases and validates through #646. | P0 / Phase 2 |
...
| 68 | `e2ed720d` | Repair timezone shift/SQLite overflow in date truncation | **Pending** | [#648](https://github.com/dannyvfilms/Floppy/issues/648) ports only the final state with a read-only audit and Floppy-native migration; upstream's intermediate migration is D4. | P0 / Phase 3 |
